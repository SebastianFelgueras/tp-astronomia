...
renderizar = ["index.html","posicion.html","medicion1.html","medicion2.html","gnomon.html"] #es demasiado obtenerlas automaticamente, igual van a ser 5 archivos, no se justifica
...
for template in renderizar:
    ...
    with open(f"{template}",mode="w",encoding="utf8") as final:
